...
- [ ] **Step 21K.3**: Train Model A0 across minimum three predeclared seeds (seeds 42, 123, 456). [NOT_YET_AUTHORIZED]
  * **Prerequisites Before Authorization**: (1) Complete 2022–2023 atmospheric mirroring (48 monthly files) and daily derivation certified via `scripts/15_verify_validation_atmospheric_pipeline.py` [PASS / CERTIFIED: 2026-09-16], (2) Current-code 21J GPU revalidation on physical Colab T4 / Pre-Production Gate 2 [PASS / CERTIFIED_ON_GPU: 2026-09-17], and (3) 21K.3-pre physical Colab T4 GPU execution (`scripts/14_run_a0_production_smoke_test.py --mode certify`) [ACTIVE PRE-REQUISITE].
