...
> [!NOTE]
> **Parent Study Archive**: This directory (`parent_study_ex29/`) contains the complete, pristine reference codebase, 48 original notebooks, functions, and data utilities from the parent study by **Kyle Lesinger & Di Tian (2025)** (*Nature Communications*, DOI: [10.1038/s41467-025-62761-3](https://doi.org/10.1038/s41467-025-62761-3)).
> For the **Mindanao Tropical Adaptation (Track B)**, refer to the repository root [`../README.md`](../README.md), [`../contracts/`](../contracts/), and [`../notebooks/`](../notebooks/).
