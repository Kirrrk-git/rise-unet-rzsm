...
Following an independent forensic code audit of `scripts/12_train_a0_tiny_overfit.py` and `scripts/13_train_a0_pipeline_checkpoint.py`, the following methodological facts are formally entered into the permanent audit record:
