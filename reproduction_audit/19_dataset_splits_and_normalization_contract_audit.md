...
- An executable contract test (`test_tensor_builder_active_normalization_contract` in [`tests/test_08_normalization_and_splits.py`](../tests/test_08_normalization_and_splits.py)) verifies:
