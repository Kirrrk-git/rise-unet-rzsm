...
* **Next Sequence**:
  ...
  * **Step 21A.7B**: Binary Evaluation Mask (`processed/grid/mindanao_eval_mask_025.nc`, [`reproduction_audit/08_mindanao_evaluation_mask_audit.md`](08_mindanao_evaluation_mask_audit.md)).
  ...
  * **Step 21A.9**: ERA5-Land RZSM Target Acceptance & Independent Cross-Reference ([`reproduction_audit/12_era5_land_target_acceptance_audit.md`](12_era5_land_target_acceptance_audit.md)).
